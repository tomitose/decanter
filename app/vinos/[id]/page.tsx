    ...
    <div className="relative min-h-screen text-white">
      ...
      <div className="pt-16 pb-8 text-center animate-fade-in">
        <div className="relative inline-block animate-float">
          <div className="relative w-48 h-[380px] md:w-56 md:h-[450px] mx-auto">
            <Image
              src={wine.imageUrl}
          ...
          <div className="absolute -top-2 -right-6 bg-wine-900 text-gold-400 px-3 py-1 rounded-full text-sm font-bold shadow-md border border-wine-700">
            {wine.year}
          </div>
        </div>
      </div>
