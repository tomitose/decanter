...
return (
// Contenedor principal de la página con el warning de hidratación
<div
...
Descubre tu próximo vino favorito
  ...
  {/* Aquí llamamos a nuestros componentes, ahora limpios y ordenados */}
  <FeaturedWines />
  <SommelierPicks />
  <MonthlyPromo />

  {/* Aquí pondremos los futuros componentes (Buscador, etc.) */}
</div>
